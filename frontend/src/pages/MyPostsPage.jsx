...
function MyPostsPage() {
  ...
  const handleDeletePost = async (postId) => {
    ...
    try {
      ...
      setPosts((previousValue) =>
        previousValue.filter((item) => item._id !== postId),
      );
  ...
  return (
    <section className="articles-page">
      <div className="articles-top-bar">
        <div>
          ...
          <p className="hero-copy articles-copy">
            Review the articles you have published and add new posts for the
            community.
          </p>
        </div>
      ...
      {isLoading ? (
        <p className="articles-status">Loading your posts...</p>
      ) : null}
          ...
          {posts.map((post) => (
            <article className="article-card" key={post._id || post.slug}>
              ...
              <div className="article-content">
                ...
                <Link
                  className="article-card-edit-inline action-button"
          ...
          <div className="modal-card">
            ...
            <div className="modal-actions">
              ...
              <button
                ...
                disabled={deletingPostId === deleteTargetPostId}
              >
                {deletingPostId === deleteTargetPostId
                  ? "Deleting..."
                  : "Delete"}
              </button>
            </div>
